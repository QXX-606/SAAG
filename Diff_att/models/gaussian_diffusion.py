...
class GaussianDiffusion(nn.Module):
    ...
    def training_losses(self, model, x_start, struct_emb, reweight=False):
        ...
        #terms是一个字典
        terms = {}
        #model_output是一个随机数，x_t是一个随机数，ts是一个随机数

        model_output = model(x_t, ts, struct_emb)
        ...
        if reweight == True:
            ...
            if self.mean_type == ModelMeanType.START_X:
                ...
                #如果ts==0，weight=1.0，否则weight=weight
